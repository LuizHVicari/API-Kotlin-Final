...
//    )
    ...
    private fun uploadImageToFirebase() {
        ...
        uploadTask.addOnFailureListener {
            ...
            imagesRef.downloadUrl.addOnSuccessListener { uri ->
                Log.d("FIREBASE", "Imagem salva como $uri")
    ...
    private fun requestLocationPermission() {
        Log.d("LOCATION", "Iniciando o pedido de permissão")
    ...
    private fun checkLocationPermissionAndRequest() {
        when {
            ...
            ActivityCompat.checkSelfPermission(this, ACCESS_COARSE_LOCATION) == PERMISSION_GRANTED -> {
                    Log.d("LOCATION", "Tem todas as permissões necessárias")
                    getLastLocation()
            }
    ...
    private fun openCamera() {
        Log.d("CAMERA", "Iniciando a abertura da camera")
        val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        Log.d("CAMERA", "Chamou o intent")
        imageUri = createImageUri()
        intent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri)
        Log.d("CAMERA", "Vai lançar a camera")
    ...
    private fun getLastLocation() {
        ...
        {
            Log.d("LOCATION", "As permissões não foram concedidas")
            requestLocationPermission()
            return
        }
        fusedLocationClient.lastLocation.addOnCompleteListener { task: Task<Location> ->
            if (task.isSuccessful) {
                Log.d("LOCATION", "A localização foi obtida")
